...
namespace HutongGames.PlayMaker.Actions {
	...
	public class GridAlignTransform : FsmGFStateActionMethodGrid {
		...
		protected override void DoAction() { grid.AlignTransform ((Transform)transform.Value, rotate.Value, new BoolVector3 (ignoreX.Value, ignoreY.Value, ignoreZ.Value)); }
	}
	...
	public class GridScaleTransform : FsmGFStateActionMethodGrid {
		...
		protected override void DoAction() { grid.ScaleTransform ((Transform)transform.Value, new BoolVector3 (ignoreX.Value, ignoreY.Value, ignoreZ.Value)); }
	}
